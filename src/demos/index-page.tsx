...
const ALL_DEMO_CARDS: DemoCard[] = [
  ...
  {
    title: 'Compliance 360 V2',
    description: 'V2 with universal Overview tab — cross-module compliance posture, urgent items list, and Rippling impact metrics.',
    path: '/compliance-360-v2',
    icon: Icon.TYPES.APPROVE_REJECT_SHIELD_OUTLINE,
    folder: '@nitish',
  },
  {
    title: 'Compliance 360 V3',
    description: 'V3 with categorized overview, registrations tab (no command center), filings with historical, and status filters on registration sub-tabs.',
    path: '/compliance-360-v3',
    icon: Icon.TYPES.APPROVE_REJECT_SHIELD_OUTLINE,
    folder: '@nitish',
  },
  {
    title: 'Compliance 360 V4',
    description: 'V4 simplified single-page view — workforce overview, unified registrations with penalties, streamlined filings, and Rippling impact. Action-first design with clickable rows.',
    path: '/compliance-360-v4',
    icon: Icon.TYPES.APPROVE_REJECT_SHIELD_OUTLINE,
    folder: '@nitish',
  },
  {
    title: 'Reconciliation Flow V1',
    description: 'Census reconciliation discrepancy grid with AI summary, Rippling vs Carrier field-by-field comparison, resolution guidance, and timeline.',
    path: '/reconciliation-flow-v1',
  ...
  },
  {
    ...
    description: 'End-to-end Benefits Overview lifecycle: 6 states from empty to steady state to renewal, with unified action queue replacing all banners.',
    path: '/benefits-lifecycle',
    icon: Icon.TYPES.HEART_OUTLINE,
    folder: '@nitish',
  },
  {
  ...
  {
    title: 'Error Report V2',
    description: 'Redesigned error report detail page with flat list view, inline accept/dismiss, Save/Approve workflow.',
    path: '/error-report-v2',
    icon: Icon.TYPES.WARNING_TRIANGLE_OUTLINE,
    folder: '@nitish',
  },
  {
    title: 'Error Report V2 (Tabbed)',
    description: 'Tabbed version with 3 tabs (Issues to review, Accepted, Dismissed) for comparison.',
    path: '/error-report-v2-tabbed',
    icon: Icon.TYPES.WARNING_TRIANGLE_OUTLINE,
    folder: '@nitish',
  },
  {
    title: 'Transmission Failures',
    description: 'EDI & API transmission failure monitoring with two-column detail views, preview panels for EDI/Census/JSON, and end-to-end triage workflow.',
    path: '/transmission-failures',
    icon: Icon.TYPES.REFRESH_OUTLINE,
    folder: '@nitish',
  },
  {
    title: 'Overview Explorations',
    description: '6 design approaches for Compliance 360 Overview action items — mini tables, structured rows, action-first, condensed, split layout, and rich tables.',
    path: '/overview-explorations',
    icon: Icon.TYPES.APPROVE_REJECT_SHIELD_OUTLINE,
    folder: '@nitish',
  },
  {
    title: 'Compliance Scenarios',
    description: 'How the Compliance 360 Overview adapts across 7 scenarios — Standard, PEO, HRIS-only, All Caught Up, Onboarding, Expanding, and Contractor-only.',
    path: '/compliance-scenarios',
    icon: Icon.TYPES.APPROVE_REJECT_SHIELD_OUTLINE,
    folder: '@nitish',
  },
  {
    title: 'Compliance 360 V5',
    description: 'V5 with dashboard-first overview — 3 summary cards (Registrations, Filings, Workforce) at top, action-only detail sections below, and Rippling Impact.',
    path: '/compliance-360-v5',
    icon: Icon.TYPES.APPROVE_REJECT_SHIELD_OUTLINE,
    folder: '@nitish',
  },
  {
    title: 'Compliance Agent',
    description: 'Rippling AI chat panel on the right, live Compliance 360 interface on the left — agent works in chat, product UI reacts in real time.',
