...
import { OverviewV5Tab } from './OverviewV5Tab';
...
export const Compliance360V5Page: React.FC = () => {
  ...
  return (
    <PageWrapper theme={theme}>
        ...
        <TabsWrapper theme={theme}>
          ...
          >
            {TAB_NAMES.map((name, i) => (
              <Tabs.Tab key={`c360v5-tab-${i}`} title={name} />
            ))}
          </Tabs.LINK>
        </TabsWrapper>
      </HeaderArea>
      ...
      <ContentArea theme={theme}>
        {activeTab === 0 && <OverviewV5Tab onNavigateToModule={handleNavigateToModule} />}
