...
const CURRENT_FILINGS: ComplianceFiling[] = ([
...
const HISTORICAL_FILINGS: ComplianceFiling[] = [
  { id: 'h1', jurisdiction: 'Federal',    fileName: 'EEO-1',           filingName: 'EEO-1 Component 1 Report (2025)',       filingOpens: 'Jan 1, 2025', dueDate: 'Mar 31, 2025', responsibleForFiling: 'COMPANY', status: 'filed' },
  { id: 'h2', jurisdiction: 'Federal',    fileName: '1094-C / 1095-C', filingName: 'ACA Annual Filing (2024)',              filingOpens: 'Jan 1, 2025', dueDate: 'Feb 28, 2025', responsibleForFiling: 'COMPANY', status: 'filed' },
  { id: 'h3', jurisdiction: 'Federal',    fileName: 'Form 940',        filingName: 'Annual FUTA Tax Return (2024)',          filingOpens: 'Jan 1, 2025', dueDate: 'Jan 31, 2025', responsibleForFiling: 'COMPANY', status: 'filed' },
  { id: 'h4', jurisdiction: 'Federal',    fileName: 'W-2 / W-3',       filingName: 'Wage & Tax Statement Distribution (2024)', filingOpens: 'Jan 1, 2025', dueDate: 'Jan 31, 2025', responsibleForFiling: 'COMPANY', status: 'filed' },
  { id: 'h5', jurisdiction: 'Federal',    fileName: 'VETS-4212',       filingName: 'VETS-4212 Report (2024)',               filingOpens: 'Aug 1, 2025', dueDate: 'Sep 30, 2025', responsibleForFiling: 'COMPANY', status: 'filed' },
  { id: 'h6', jurisdiction: 'California', fileName: 'SB 973',          filingName: 'California Pay Data Report (2024)',      filingOpens: 'Jan 1, 2025', dueDate: 'Mar 31, 2025', responsibleForFiling: 'COMPANY', status: 'filed' },
  { id: 'h7', jurisdiction: 'New York',   fileName: 'PFL-120',         filingName: 'NY Paid Family Leave Annual Statement (2024)', filingOpens: 'Jan 1, 2025', dueDate: 'Mar 1, 2025', responsibleForFiling: 'COMPANY', status: 'filed' },
  { id: 'h8', jurisdiction: 'Federal',    fileName: 'Form 941',        filingName: 'Q4 2024 Federal Tax Return',            filingOpens: 'Jan 1, 2025', dueDate: 'Jan 31, 2025', responsibleForFiling: 'COMPANY', status: 'filed' },
];
...
const FilingsTable: React.FC<{ filings: ComplianceFiling[]; title: string }> = ({ filings, title }) => {
...
export const FilingsV3Tab: React.FC<{ activeSubTab: number }> = ({ activeSubTab }) => {
  const { theme } = usePebbleTheme();

  return (
    <TabContent theme={theme}>
      {activeSubTab === 0 && (
        <FilingsTable filings={CURRENT_FILINGS} title="Report filings" />
      )}
      {activeSubTab === 1 && (
        <>
          <HistoricalNote theme={theme}>
            Previously completed filings from prior filing periods.
          </HistoricalNote>
          <FilingsTable filings={HISTORICAL_FILINGS} title="Previous filings" />
        </>
      )}
    </TabContent>
  );
